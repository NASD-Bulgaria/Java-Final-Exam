 ...
 * @author metodi
 */
@WebServlet(name = "TakenSumServlet", urlPatterns = {"/TakenSumServlet"})
public class TakenSumServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
               double sum=Double.parseDouble(request.getParameter("balance1"));
               if (sum>0) {
                   
                String balance=Queries.TakeSum(userName, password, sum);
