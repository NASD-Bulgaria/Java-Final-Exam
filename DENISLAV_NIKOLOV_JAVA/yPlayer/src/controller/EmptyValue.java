...
/**
 * Servlet implementation class EmptyValue
 */
@WebServlet("/EmptyValue")
public class EmptyValue extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<CENTER>" + "<form action=\"http://localhost:8080/yPlayer/Withdraw\">"
				+ "<input type=\"submit\" value=\"Back to withdraw page\" />" + "</form>");
	}
